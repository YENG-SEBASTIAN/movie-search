    ...
    return (
        <div className="py-10 px-4 lg:px-20">
            ...
            <div className="flex flex-col lg:flex-row lg:items-start">
                ...
                <div className="lg:ml-8 mt-8 lg:mt-0 w-full lg:w-2/3">
                    {/* Original Title */}
                    <div className="mt-4">
                        <h3 className="text-xl font-semibold text-black italic">Original Title</h3>
                    ...
                    {/* Overview */}
                    <h2 className="text-2xl font-semibold mb-4 text-black italic mt-6">Overview</h2>
                    <p className="text-gray-600 italic">
                    ...
                    {movieDetail.movie.homepage && (
                        <div className="mt-4">
                            <h3 className="text-xl font-semibold text-black italic">Homepage</h3>
                            <a
                    ...
                    {/* Release Date */}
                    <div className="mt-6">
                        <h3 className="text-xl font-semibold text-black italic">Release Date</h3>
                        <p className="text-gray-600 italic">
                    ...
                    {/* Rating */}
                    <div className="mt-4">
                        <h3 className="text-xl font-semibold text-black italic">Rating</h3>
                        <p className="text-gray-600 italic">
                    ...
                    {/* Vote Count */}
                    <div className="mt-4">
                        <h3 className="text-xl font-semibold text-black italic">Vote Count</h3>
                        <p className="text-gray-600 italic">
                    ...
                    {/* Popularity */}
                    <div className="mt-4">
                        <h3 className="text-xl font-semibold text-black italic">Popularity</h3>
                        <p className="text-gray-600 italic">
                    ...
                    {/* Genres */}
                    <div className="mt-4">
                        <h3 className="text-xl font-semibold text-black italic">Genres</h3>
                        <p className="text-gray-600 italic">
                    ...
                    {/* Origin Country */}
                    <div className="mt-4">
                        <h3 className="text-xl font-semibold text-black italic">Origin Country</h3>
                        <p className="text-gray-600 italic">
                    ...
                    {/* Tagline */}
                    <div className="mt-4">
                        <h3 className="text-xl font-semibold text-black italic">Tagline</h3>
                        <p className="text-gray-600 italic">{movieDetail.movie.tagline || "Tagline not available"}</p>
                    </div>
                    ...
                    {movieDetail.movie.status && (
                        <div className="mt-4">
                            <h3 className="text-xl font-semibold text-black italic">Status</h3>
